...
######################################################################
def hawkid():
    return(["Chiamaka Nwajiaku", "nwajiaku"])
...
# Ask the user for mode, count, and values
mode = input("Enter a mode (min, max, avg): ")
while mode not in ['min', 'max', 'avg']:
    print("Invalid input. Please enter either 'min', 'max', or 'avg'.")
    mode = input("Enter a mode (min, max, avg): ")
